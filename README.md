...
<br />
<em>Note: Once signed-in, you don't need to keep the other browser tab/window open in order to stay signed-in on the dashboard.</em></p>
</details>

<details>
 <summary><h3>I have other questions about Prophix</h3></summary>

 <p>You can open the <a href="https://help.prophix.cloud/">Prophix help page here</a> or <a href="mailto:msmith@gpsfx.com">email Mathew Smith</a> for GPS-specific Prophix questions.</p>
</details>
